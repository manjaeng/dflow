...
public interface UserService {
    ...
    int updateUserCompany(UserVO user) throws Exception;
    ...
    EgovMap isDuplicateCheck(EgovMap userId) throws Exception;
    List<EgovMap> selectDfUserCodeMap(EgovMap userId) throws Exception;
}