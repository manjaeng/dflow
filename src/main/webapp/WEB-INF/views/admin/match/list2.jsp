								...
								<tbody>
									<c:forEach var="item" items="${matchList}">
										<tr>
											...
											<td><c:out value="${item.waist1}" /></td>
											<td><c:out value="${item.waist2}" /></td>
											<td><c:out value="${item.sleeve1}" /></td>
											<td><c:out value="${item.sleeve2}" /></td>
										    <td><c:out value="${item.upperarm1}" /></td>
											<td><c:out value="${item.upperarm2}" /></td>
											<td><c:out value="${item.thigh1}" /></td>
											<td><c:out value="${item.thigh2}" /></td>
