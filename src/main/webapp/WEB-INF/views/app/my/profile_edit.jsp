							...
							<div class="dd">
								<div class="sel">
									<select class="select">
										...
										<option <c:out value="${profileInfo.country eq 'taiwan' ? 'selected' : ''}"/>>TAIWAN</option>
										<option <c:out value="${profileInfo.country eq 'indonesia' ? 'selected' : ''}"/>>INDONESIA</option>
										<option <c:out value="${profileInfo.country eq 'hongkong' ? 'selected' : ''}"/>>HONGKONG</option>
										<option <c:out value="${profileInfo.country eq 'singapore' ? 'selected' : ''}"/>>SINGAPORE</option>
										<option <c:out value="${profileInfo.country eq 'malaysia' ? 'selected' : ''}"/>>MALAYSIA</option>
										<option <c:out value="${profileInfo.country eq 'thiland' ? 'selected' : ''}"/>>THAILAND</option>
										<option <c:out value="${profileInfo.country eq 'philippines' ? 'selected' : ''}"/>>PHILIPPINES</option>
										<option <c:out value="${profileInfo.country eq 'vietnam' ? 'selected' : ''}"/>>VIETNAM</option>
