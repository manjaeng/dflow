	...
	<div class="container-fluid px-xl-7 pt-5 pb-3 pb-lg-6">
		...
		<div class="row">
			<div class="col-lg-6 col-xl-7 pt-4 order-2 order-lg-1 photoswipe-gallery"><a class="d-block mb-4" href="/resources/app/images/dflow/product01.jpeg" data-caption="Push-up Jeans 1 - Caption text" data-toggle="photoswipe" data-width="1200" data-height="1200">
				<div data-toggle="zoom" data-image="/resources/app/images/dflow/product01.jpeg"><img class="img-fluid" src="/resources/app/images/dflow/product01.jpeg" alt="Push-up Jeans 1"></div></a><a class="d-block mb-4" href="img/product/detail-1-gray.jpg" data-caption="Push-up Jeans 2 - Caption text" data-toggle="photoswipe" data-width="1200" data-height="1200">
				<div data-toggle="zoom" data-image="/resources/app/images/dflow/product01.jpeg"><img class="img-fluid" src="/resources/app/images/dflow/product03.jpeg" alt="Push-up Jeans 3"></div></a><a class="d-block mb-4" href="img/product/detail-4-gray.jpg" data-caption="Push-up Jeans 4 - Caption text" data-toggle="photoswipe" data-width="1200" data-height="1200">
				<div data-toggle="zoom" data-image="/resources/app/images/dflow/product01.jpeg"><img class="img-fluid" src="/resources/app/images/dflow/product04.jpeg" alt="Push-up Jeans 4"></div></a><a class="d-block mb-4" href="img/product/detail-5-gray.jpg" data-caption="Push-up Jeans 5 - Caption text" data-toggle="photoswipe" data-width="1200" data-height="1200">
				<div data-toggle="zoom" data-image="/resources/app/images/dflow/product01.jpeg"><img class="img-fluid" src="/resources/app/images/dflow/product05.jpeg" alt="Push-up Jeans 5"></div></a><a class="d-block mb-4" href="img/product/detail-6.jpg" data-caption="Push-up Jeans 6 - Caption text" data-toggle="photoswipe" data-width="1200" data-height="1200">
				<div data-toggle="zoom" data-image="/resources/app/images/dflow/product01.jpeg"><img class="img-fluid" src="/resources/app/images/dflow/product06.jpeg" alt="Push-up Jeans 6"></div></a>
			</div>
			<div class="col-lg-6 col-xl-4 pt-4 order-1 order-lg-2 ml-lg-auto">
				<div class="sticky-top" style="top: 100px;">
					<h1 class="mb-4">★김나영,보라끌레르,예리 픽!★5차 리오더★ THE WIDE 데일리데님_Wide</h1>
					...
					<form id="buyForm" action="#">
						<div class="row">
							...
							<div class="col-sm-6 col-lg-12 detail-option mb-5">
								...
								<label class="btn btn-sm btn-outline-primary detail-option-btn-label" for="material_0"> 심플
									<input class="input-invisible" type="radio" name="material" value="value_0" id="material_0" required>
								</label>
								<label class="btn btn-sm btn-outline-primary detail-option-btn-label" for="material_1"> 오피스
