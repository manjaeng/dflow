            ...
            <div class="container-fluid">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <strong>이용약관 동의(필수)</strong> 이용약관 내용
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <strong>개인정보 수집 동의(필수)</strong> 개인정보 수집동의 내용
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" value=''>
                                                                    <span class="form-check-sign">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">개인정보 등록</h4>
                                <p class="card-category">개인정보를 등록해 주세요</p>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">셀러회원운 업체정보를 등록해주세요</p>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="dropdown" name="store_name" id="select">
                                                    <a class="btn btn-secondary dropdown-toggle" href="" id="addrDropdownMenuLink" data-toggle="dropdown" >
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="addrDropdownMenuLink">
                                                        ...
                                                        <li><a class="dropdown-item" value="DDP 패션몰(유어스)">DDP 패션몰(유어스)</a></li>
                                                        <li><a class="dropdown-item" value="APM">APM</a></li>
                                                        <li><a class="dropdown-item" value="APM 럭스">APM 럭스</a></li>
                                                        <li><a class="dropdown-item" value="APM PLACE">APM PLACE</a></li>
                                    ...
                                    <a type="button" href=""  class="btn btn-primary btn-round pull-right">회원가입</a>
